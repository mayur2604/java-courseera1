...
public class FileResource {
     ...
     * 
     * @throwsexception if no file is selected by the user
     */
    public FileResource () {
        initRead();
    }
     ...
     * @throwsexception if the file cannot be accessed
     */
     ...
     * @throwsexception if the filename cannot be accessed
     */
     ...
     *         time
     * @throwsexception if this file does not represent a CSV formatted data
     */
     ...
     *         time
     * @throwsexception if this file does not represent a CSV formatted data
     * @throwsexception if <code>delimiter.length() != 1</code>
     */
